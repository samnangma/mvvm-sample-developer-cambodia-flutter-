...
class _CourseDetailState extends State<CourseDetail>
  ...
  void initState() {
    ...
    _tabController = TabController(
        length: 3, vsync: this); // Replace '3' with the number of tabs you have
  }
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Image.network(
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEbBx4RbXegadSjRovxQlnkQytBX9_Wv6u6mPEaDKGYv82z13fUalqMlXsydkmp53C8rc&usqp=CAU",
                width: double.maxFinite,
                fit: BoxFit.cover,
              ),
            ),
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.people),
                      TextButton(onPressed: () {}, child: Text("Kit tara"))
                    ],
                  ),
                  Row(
                    children: [
                      Icon(Icons.people),
                      TextButton(onPressed: () {}, child: Text("Lesson"))
                    ],
                  ),
                  const Row(
                    children: [
